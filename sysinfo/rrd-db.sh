...
rrdtool create /opt/FDMR-Monitor/sysinfo/tempC.rrd \
--step 300 \
...
# Db for memory usage
rrdtool create /opt/FDMR-Monitor/sysinfo/mem.rrd \
--step 300 \
...
# Db for disk usage
rrdtool create /opt/FDMR-Monitor/sysinfo/hdd.rrd \
--step 300 \
...
# Db for CPU load
rrdtool create /opt/FDMR-Monitor/sysinfo/load.rrd -s 60 \
